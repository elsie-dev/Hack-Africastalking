...
//V2 ROUTES IMPORT
const authRoutes2 = require('./routesv2/auth2')
const userRoutes2 = require('./routesv2/user2')
const blogRoutes2 = require('./routesv2/blog2')
const contactUsRoute2 = require('./routesv2/contactus')
...
app.use('/api/v2/user', userRoutes2)
app.use('/api/v2/blog', blogRoutes2)
app.use('/api/v2/', contactUsRoute2)
